...
if ($num == 1){
 ...
 $form .="<a href='http://www.meetemplates.com' target='blank' alt='Mobile templates'>Mobile templates</a>";

}else if($num == 2){
    $form .="<a href='http://www.meetemplates.com' target='blank' alt='Mobile websites'>Mobile websites</a>";
}else if($num == 3){
    $form .="<a href='http://www.meetemplates.com' target='blank' alt='Mobile website template'>Mobile website template</a>";
}else if($num == 4){
    $form .="<a href='http://www.meetemplates.com' target='blank' alt='Mobile website'>Mobile website</a>";
}else{
    $form .="<a href='http://www.meetemplates.com' target='blank' alt='wordpress templates'>Wordpress templates</a>";
}
