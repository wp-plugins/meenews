...
function newsletter_menu() {
    ...
    if (function_exists('add_submenu_page')) {
		add_submenu_page('wp-TVnewsletter/Configuration.php', __('Configuracion', 'wp-TVnewsletter'), __('Configuracion', 'wp-TVnewsletter'), 'manage_newsletter', 'wp-TVnewsletter/Configuration.php');
        add_submenu_page('wp-TVnewsletter/Configuration.php', __('Suscritos y Categorias', 'wp-TVnewsletter'), __('Suscritos y Categorias', 'wp-TVnewsletter'), 'manage_newsletter', 'wp-TVnewsletter/catandsuscribes.php');
        add_submenu_page('wp-TVnewsletter/Configuration.php', __('Diseño Newsletter', 'wp-TVnewsletter'), __('Diseño Newsletter', 'wp-TVnewsletter'), 'manage_newsletter', 'wp-TVnewsletter/designNewsletter.php');
        add_submenu_page('wp-TVnewsletter/Configuration.php', __('Envios', 'wp-TVnewsletter'), __('Envios', 'wp-TVnewsletter'), 'manage_newsletter', 'wp-TVnewsletter/manageNewsletters.php');
        add_submenu_page('wp-TVnewsletter/Configuration.php', __('Desinstalar', 'wp-TVnewsletter'), __('Desinstalar', 'wp-TVnewsletter'), 'manage_newsletter', 'wp-TVnewsletter/uninstall.php');
	}
